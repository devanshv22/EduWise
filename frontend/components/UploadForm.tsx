...
const UploadForm: React.FC<UploadFormProps> = ({ fetchUploadedFiles, onClose, username }) => {
    ...
    const fetchFacultyList = async () => {
        try {
            const response = await axios.get('https://edu-wise-backend.onrender.com/api/faculty');
    ...
    const fetchCourseList = async () => {
        try {
            const response = await axios.get('https://edu-wise-backend.onrender.com/api/courses');
    ...
    const handleNewInstructorSubmit = async (newInstructorName: string) => {
        try {
            await axios.post('https://edu-wise-backend.onrender.com/api/faculty', { name: newInstructorName });
    ...
    const handleNewCourseSubmit = async (newCourseName: string) => {
        try {
            await axios.post('https://edu-wise-backend.onrender.com/api/courses', { name: newCourseName });
    ...
    const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
        ...
        try {
            await axios.post('https://edu-wise-backend.onrender.com/api/upload', formData, {
                headers: {
